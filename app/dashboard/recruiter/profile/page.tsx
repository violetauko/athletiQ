...
import { ClientProfileForm } from '@/components/dashboard/client/client-profile-form';
import { ClientOverview } from '@/components/dashboard/client/client-overview';

export const metadata: Metadata = {
  title: 'Client Profile | Athletic Performance Agency',
      ...
      <div className="min-h-screen bg-stone-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Please complete your profile setup to start posting opportunities.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ClientProfileForm userId={session.user.id} />
          </CardContent>
        </Card>
      </div>
    );
